...
<link href="<%= Url.Content("~/Content/css/samplebrowser.css")%>" rel="stylesheet"
  ...
  <%--  <link rel="Stylesheet" type="text/css" href="<%= Url.Content("~/Content/css/jquery_news_ticker/styles/style.css?v=2011-04-25")%>" />--%>
    <link rel="Stylesheet" type="text/css" href="<%= Url.Content("~/Content/css/jquery_news_ticker/styles/ticker-style.css")%>" />
