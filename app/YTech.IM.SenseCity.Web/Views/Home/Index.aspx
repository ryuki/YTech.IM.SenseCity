...
<%@ Import Namespace="YTech.IM.SenseCity.Web.Controllers" %>
    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within YTech.IM.SenseCity.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within YTech.IM.SenseCity.Data.NHibernateMaps.GetConventions()
            ...
            <li>
                Open YTech.IM.SenseCity.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                YTech.IM.SenseCity.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
